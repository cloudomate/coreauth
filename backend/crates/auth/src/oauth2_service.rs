...
impl OAuth2Service {
    ...
    pub async fn create_authorization_request(
        ...
        let auth_request = sqlx::query_as::<_, AuthorizationRequest>(
            ...
            INSERT INTO oauth_authorization_requests (
                ...
                code_challenge, code_challenge_method, nonce, organization_id,
    ...
    pub async fn create_authorization_code(
        ...
        sqlx::query(
            ...
            INSERT INTO oauth_authorization_codes (
                code, client_id, user_id, organization_id, redirect_uri, scope,
    ...
    pub async fn generate_tokens(
        ...
        sqlx::query(
            r#"
            INSERT INTO oauth_access_tokens (jti, client_id, user_id, organization_id, scope, expires_at)
            VALUES ($1, $2, $3, $4, $5, $6)
            "#,
        )
        .bind(&jti)
    ...
    async fn create_refresh_token(&self, request: CreateRefreshToken) -> Result<String> {
        ...
        sqlx::query(
            ...
            INSERT INTO oauth_refresh_tokens (
                token_hash, client_id, user_id, organization_id, scope, audience, expires_at
    ...
    pub async fn revoke_token(&self, token: &str, client_id: Uuid) -> Result<()> {
        let token_hash = {
            let mut hasher = Sha256::new();
            hasher.update(token.as_bytes());
            format!("{:x}", hasher.finalize())
    ...
    pub async fn create_login_session(&self, request: CreateLoginSession) -> Result<String> {
        ...
        sqlx::query(
            ...
            INSERT INTO login_sessions (
                session_token_hash, user_id, organization_id, ip_address, user_agent,
    ...
    pub async fn validate_login_session(&self, session_token: &str) -> Result<LoginSession> {
        ...
        let session = sqlx::query_as::<_, LoginSession>(
            r#"
            SELECT id, session_token_hash, user_id, organization_id,
    ...
    pub async fn grant_consent(
        ...
        let consent = sqlx::query_as::<_, OAuthConsent>(
            r#"
            INSERT INTO oauth_consents (user_id, client_id, organization_id, scopes)
            VALUES ($1, $2, $3, $4)
    ...
    pub async fn revoke_consent(&self, user_id: Uuid, client_id: Uuid) -> Result<()> {
        sqlx::query(
    ...
    pub async fn get_application_by_client_id(
        ...
        sqlx::query_as::<_, Application>(
            "SELECT * FROM applications WHERE client_id = $1 AND is_enabled = true",
        )
        .bind(client_id)
        .fetch_optional(self.db.pool())
        .await
