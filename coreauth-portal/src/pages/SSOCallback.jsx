...
// Use axios directly without the 401 interceptor for the callback
...
export default function SSOCallback() {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      try {
        // Exchange code for tokens (use publicApi to avoid 401 interceptor)
        const response = await publicApi.get('/oidc/callback', {
          params: { code, state },
        });
