...
impl OrganizationMemberRepository {
    ...
    pub async fn add_member(
        ...
        let member = sqlx::query_as!(
            ...
            VALUES ($1, $2, $3)
            RETURNING id, user_id, tenant_id as organization_id, role, joined_at
            "#,
            request.user_id,
    ...
    /// Remove a user from an organization (tenant)
    ...
    pub async fn get_member(
        ...
        let member = sqlx::query_as!(
            OrganizationMember,
            r#"
            SELECT id, user_id, tenant_id as organization_id, role, joined_at
            FROM tenant_members
            WHERE user_id = $1 AND tenant_id = $2
            "#,
            user_id,
